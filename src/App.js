  ...
  const [movieData, setMovieData]= useState([
    {
      ...
      rating:<StarRating name="small-rating" caption="Small!" size={30} totalStars={5} rating={3} />
      ...
      rating:<reactStarRatingMin name="small-rating" caption="Small!" size={30} totalStars={5} rating={3} />
      },
      {
        id: Math.random(),
